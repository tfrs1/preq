...
func (c *MockClient) GetPullRequests(
	o *GetPullRequestsOptions,
...
func (c *MockClient) DeclinePullRequest(
	o *DeclinePullRequestOptions,
) (*PullRequest, error) {
	return nil, c.ErrorValue
}
...
func (c *MockClient) Merge(o *MergeOptions) (*PullRequest, error) {
	return nil, c.ErrorValue
}
